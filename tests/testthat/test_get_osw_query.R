...
test_that("test_getQuery",{
  ...
  outData <- getQuery(maxFdrQuery = 0.03, oswMerged = TRUE, analytes = NULL,
                      filename = "DIAlignR/testFile.mzML", runType = "DIA_Proteomics")
...
test_that("test_getAnalytesQuery",{
  ...
  outData <- getAnalytesQuery(maxFdrQuery = 0.03, oswMerged = TRUE,
                              filename = "DIAlignR/testFile.mzML", runType = "DIA_Metabolomics")
  ...
  expect_identical(outData, expOutput)
  outData <- getAnalytesQuery(maxFdrQuery = 0.0005, oswMerged = FALSE,
                              filename = "DIAlignR/testFile.mzML", runType = "DIA_Proteomics")
